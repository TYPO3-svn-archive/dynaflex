 ...
 *
 * $Id: class.t3lib_flexformtools.php,v 1.1.2.6 2006/04/06 13:49:39 mundaun Exp $
 *
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/dynaflex/class.ux_t3lib_flexformtools.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/dynaflex/class.ux_t3lib_flexformtools.php']);
}
?>
